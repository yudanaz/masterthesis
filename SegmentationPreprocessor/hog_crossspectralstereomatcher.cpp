...
void HOG_crossSpectralStereoMatcher::process(Mat imgRGB_L, Mat imgNIR_R, Mat& out_disp)
{
    ...
    if(disparityOptimimizationStragey == dispOpt_WTA)
    {
        ...
        disp = makeDisparity_WTA(descriptorsValues_RGB, descriptorsValues_NIR, d1.winSize,
    ...
    else if(disparityOptimimizationStragey == dispOpt_SGBM)
    {
        ...
        Mat disp16;
        compute_SGBM_HOG(rgb_resized, nir_resized, disp16, sgbm, descriptorsValues_RGB, descriptorsValues_NIR, blockSize, nCells, d1.nbins);
