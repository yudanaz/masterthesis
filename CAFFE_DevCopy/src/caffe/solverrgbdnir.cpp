...
SolverRGBDNIR<Dtype>::SolverRGBDNIR(const SolverParameter& param)
    : net_() {
  Init(param);
}

template <typename Dtype>
SolverRGBDNIR<Dtype>::SolverRGBDNIR(const string& param_file)
    : net_() {
...
template <typename Dtype>
void SolverRGBDNIR<Dtype>::Init(const SolverParameter& param) {
...
template <typename Dtype>
void SolverRGBDNIR<Dtype>::InitTrainNet() {
  ...
  ((NetRGBDNIR<Dtype>)net_).setup(imageListURL, patchSize, height, width, batchSize);
  ////////////////////////////////////////////////////////////////////////////////
...
template <typename Dtype>
void SolverRGBDNIR<Dtype>::InitTestNets() {
  ...
  for (int i = 0; i < num_test_net_instances; ++i) {
    ...
    /// RGBDNIR extension of original Solver class: ////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////
    test_nets_[i].reset(new NetRGBDNIR<Dtype>(net_param));
    std::string imageListURL = param_.rgbdnir_param().testimgsurl();
    int patchSize = param_.rgbdnir_param().patchsize();
    int height = param_.rgbdnir_param().imgheight();
    int width = param_.rgbdnir_param().imgwidth();
    int batchSize = param_.rgbdnir_param().testbatchsize();
    ((NetRGBDNIR)test_net_[i]).setup(imageListURL, patchSize, height, width, batchSize);
    ////////////////////////////////////////////////////////////////////////////////
    /// endof RGBDNIR extension of original Solver class: //////////////////////////
    ////////////////////////////////////////////////////////////////////////////////
  }
...
template <typename Dtype>
void SolverRGBDNIR<Dtype>::Solve(const char* resume_file) {
  ...
  for (; iter_ < param_.max_iter(); ++iter_) {
    ...
    /// RGBDNIR extension of original Solver class: ////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////
    ((NetRGBDNIR<Dtype>)net_).feedNextPatchesToInputLayers();
    Dtype loss = net_->ForwardBackward(bottom_vec);
    ////////////////////////////////////////////////////////////////////////////////
    /// endof RGBDNIR extension of original Solver class: //////////////////////////
    ////////////////////////////////////////////////////////////////////////////////
...
template <typename Dtype>
void SolverRGBDNIR<Dtype>::Test(const int test_net_id) {
...
//        test_net->Forward(bottom_vec, &iter_loss);
    ...
    /// RGBDNIR extension of original Solver class: ////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////
    ((NetRGBDNIR<Dtype>)test_net).feedNextPatchesToInputLayers();
