...
StereoSGBM_HOG::StereoSGBM_HOG()
{
}

void StereoSGBM_HOG::operator()(InputArray leftarr, InputArray rightarr, OutputArray disparr, StereoSGBM params)
{
    ...
    if( params.speckleWindowSize > 0 )
        filterSpeckles(disp, (params.minDisparity - 1)* params.DISP_SCALE, params.speckleWindowSize,
                       params.DISP_SCALE*params.speckleRange, buffer);
}
 ...
 */
void StereoSGBM_HOG::calcPixelCostBT( const Mat& img1, const Mat& img2, int y,
 ...
 */
void StereoSGBM_HOG::computeDisparitySGBM(const Mat& img1, const Mat& img2,
