...
////////////////////////////////////////////////////////////////////////////////
bool Read_RGBDNIR_ToDatum(const string& filename, const int label,
    const int height, const int width, const bool is_color, Datum* datum);

inline bool Read_RGBDNIR_ToDatum(const string& filename, const int label,
    const int height, const int width, Datum* datum) {
  return Read_RGBDNIR_ToDatum(filename, label, height, width, true, datum);
}

inline bool Read_RGBDNIR_ToDatum(const string& filename, const int label,
    Datum* datum) {
  return Read_RGBDNIR_ToDatum(filename, label, 0, 0, datum);
}
////////////////////////////////////////////////////////////////////////////////
